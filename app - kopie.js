...
const poznavaci_ = [
    ...
    {
        number: 132,
        text: "Jaká nejtrapnější věc se ti stala na rande?",
        category: ""
    },
    {
        number: 133,
...
const crazy_ = [
    ...
    {
        number: 0,
        text: "Čůral/a jsi někdy do bazénu?",
        category: ""
    },
    {
        number: 0,
    ...
    {
        number: 0,
        text: "Kdy naposledy ses pokálel?",
        category: ""
    },
    {
        number: 0,
...
questions = updateUnits()
console.log(questions);
// const dict = new Set();
// const obj = { poznavaci_,hypoteticke_,crazy_};

// var result;

// function vysledne_pole(){
...
// vysledne_pole()
// const ahojky = vysledne_pole()
// console.log("výsledné pole");
// console.log(ahojky);
