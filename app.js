...
let vygenerovanaRandomCisla = myRandomInts(questions.length-1, questions.length-1) ;
...
if(indexRandomCisla<(questions.length-1)){
    console.log("index je: " + questionIndex);
    cardText.textContent = questions[questionIndex].text;
    indexRandomCisla++;
    ...
    cardText.textContent = "V TOMTO BALÍČKU NEJSOU DALŠÍ NOVÉ OTÁZKY K ZOBRAZENÍ.";   
    }
    numberInfo()
})
...
if(indexRandomCisla>0){    
    ...
    cardText.textContent = "JSI NA ÚPLNÉM ZAČÁTKU, VYLOSUJ SI PRVNÍ OTÁZKU."; 
    indexRandomCisla ==0;
...
shuffle.addEventListener("click",()=>{
    indexRandomCisla = 0;
vygenerovanaRandomCisla = myRandomInts(questions.length-1, questions.length-1) ;
numberInfo()
...
// FUNKCE
function numberInfo(){
    cardInfo.innerHTML = `${indexRandomCisla} / ${questions.length}`;
}
...
var crazyCheckbox = document.querySelector(".crazy");
    ...
    if (poznavaciCheckbox.checked == false && hypotetickeCheckbox.checked == false && crazyCheckbox.checked == false){
    questions = [];
    cardText.textContent = "Vyber v nastavení alespoň 1 typ otázek";
    }

    else if (poznavaciCheckbox.checked == false && hypotetickeCheckbox.checked == false && crazyCheckbox.checked == true){
    questions = crazy_;
    }   

    else if (poznavaciCheckbox.checked == false && hypotetickeCheckbox.checked == true && crazyCheckbox.checked == false){
    questions = hypoteticke_;
    } 

    else if (poznavaciCheckbox.checked == false && hypotetickeCheckbox.checked == true && crazyCheckbox.checked == true){
    questions = [...hypoteticke_,...crazy_];
    } 

    else if (poznavaciCheckbox.checked == true && hypotetickeCheckbox.checked == false && crazyCheckbox.checked == false){
    questions = poznavaci_;
    } 

    else if (poznavaciCheckbox.checked == true && hypotetickeCheckbox.checked == false && crazyCheckbox.checked == true){
    questions = [...poznavaci_,...crazy_];
    } 
    
    else if (poznavaciCheckbox.checked == true && hypotetickeCheckbox.checked == true && crazyCheckbox.checked == false){
...
vygenerovanaRandomCisla = myRandomInts(questions.length-1, questions.length) ;
numberInfo()
